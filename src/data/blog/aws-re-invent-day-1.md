...
Just a quick recap, if you missed [Day 0](https://binaryheap.com/aws-reinvent-day-0/), no worries. Head on over to that link to gain some insights into the pre:Invent festivities that I took part in this year. Don't worry, this recap will still be waiting for you when you are done!

Alright, onto Day 1.

### Meeting up with friends

My Day 0 sort of went late into the night on Day 1 but that didn't stop me from waking up and having breakfast with Adam Tran and Logan Schmidt. I might be getting old, but I don't remember breakfast being included until Tuesday morning, so it was a nice surprise to see fruit, pastries and granola provided at the MGM this morning. Adam and Logan are first-timers, so I had a chance to share some tips, many of which are documented [here](https://binaryheap.com/attending-your-first-reinvent/).
...
After a short stop at the hub, I joined up with some fellow community members and hit the expos. My favorite booth stop tonight was hands down the [Serverless Guru's booth](https://www.serverlessguru.com/). Ryan and his team are super nice and knowledgeable. Check them out if you are at re:Invent this week.
...
If you at re: Invent and would like to meet up, here's [my contact card](https://hihello.me/hi/benjamenpyle). Drop me an email or text me. I'd love to chat!

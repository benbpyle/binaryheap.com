---
title: "Attending your First re:Invent"
author: "Benjamen Pyle"
description: "First off, this post is not affiliated with AWS or the re:Invent conference. The content below contains opinions and some tips for navigating your first re:Invent conference. I believe that if you are"
pubDatetime: 2023-09-24T00:00:00Z
tags:
  - aws
  - conference
draft: false
...
The [AWS re:Invent Portal](https://reinvent.awsevents.com) is your home for all key information regarding schedules, sessions, accommodations and timings. So please, whatever I write below, confirm on that portal before making final plans.
...
1.  Arrival (timings)
2.  Accommodations (conference navigation)
...
For reference, [here is](https://reinvent.awsevents.com/campus/?trk=direct) the link to the re:Invent campus layout.
...
1.  Price is important. I'd rather spend my money somewhere else.
2.  Proximity also matters. You are going to want access to shuttles, trams or easy walking.
3.  Above all else, it's just a room. A place to lay your head after a long day.
...
Lastly, use the tram, if it's convenient. In years past, AWS has paid for conference access to the [Las Vegas monorail](https://www.lvmonorail.com/route-map/) for the entire week. This tram is frequent, usually under-utilized and sort of a hidden gem of the conference.

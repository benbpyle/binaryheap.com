---
title: Building an API Gateway with Istio and EKS
author: "Benjamen Pyle"
description: "Working with Kubernetes opens a world of possibilities in a software project. That's one of its biggest appeals to me as a developer. And when building with distributed systems, one of the components"
...
All of these parts and pieces are nice, but how do they connect with [AWS EKS](https://binaryheap.com/linkerd-service-mesh-aws-eks/) and can I produce a working solution? This walkthrough will be fairly in-depth so starting off with the cluster build.
...
![eks api gateway](/images/load_balancer-1024x636.jpg)
...
![istio pods](/images/istio_pods-1024x636.jpg)
...
![](/images/rust_services-1024x636.jpg)
